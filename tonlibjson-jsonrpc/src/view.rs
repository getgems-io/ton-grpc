...
use tonlibjson_client::block::{BlockHeader, BlockIdExt, InternalTransactionId, RawMessage, RawTransaction, ShardsResponse};
...
impl From<ShardsResponse> for ShardsView {
    fn from(shards: ShardsResponse) -> Self {
        Self {
            shards: shards
                .shards
                .into_iter()
