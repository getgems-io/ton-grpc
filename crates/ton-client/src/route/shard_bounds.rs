...
impl ShardBounds {
    pub fn from_left(left: BlockHeader) -> Self {
        Self {
            left: Some(left),
            right: None,
            right_seqno: None,
    ...
    pub fn from_right(right: BlockHeader) -> Self {
        Self {
            left: None,
...
impl ShardBounds {
    pub fn left(&self) -> Option<&BlockHeader> {
        self.left.as_ref()
    }

    pub fn right(&self) -> Option<&BlockHeader> {
        self.right.as_ref()
    }

    pub fn left_replace(&mut self, left: BlockHeader) -> Option<BlockHeader> {
        self.left.replace(left)
    }

    pub fn right_replace(&mut self, right: BlockHeader) -> Option<BlockHeader> {
