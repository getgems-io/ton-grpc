...
use crate::route::shard_bounds::ShardBounds;
use crate::route::shard_prefix::ShardPrefix;
use crate::route::{ChainId, Seqno, ShardId};
...
impl Registry {
    ...
    pub fn upsert_left(&self, header: &BlockHeader) {
    ...
    pub fn upsert_right(&self, header: &BlockHeader) {
        let shard_id = (header.id.workchain, header.id.shard);
    ...
    pub fn upsert_right_end(&self, block_id: &BlockIdExt) {
